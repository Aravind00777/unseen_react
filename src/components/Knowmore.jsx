...
export default function Knowmore(){
    ...
    return <section className='relative z-[2] py-ptA1 max-3xl:py-20 text-white'>
        ...
        <div className="container text-center">
                <h3 className='text-45px max-3xl:text-[40px] max-2xl:text-4xl font-bold'>{Knowmore.knowmore_title}</h3>
                <p className='text-lg py-5'>{Knowmore.knowmore_cnt}</p>
                <a href="#" className='block duration-300 ease-in-out hover:bg-white hover:text-dark-pink rounded-full max-w-max282 text-2xl max-2xl:text-xl py-[19px] mx-auto px-[50px] font-semi border border-white'>{Knowmore.knowmore_btn}</a>
        </div>
    </section>
}