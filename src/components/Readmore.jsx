    ...
    return <section className="bg-black py-16">
        <div className="container">
            <div className='relative z-[1]'>
                ...
                <h2 className='text-45px max-3xl:text-[40px] max-2xl:text-4xl max-lg:text-2xl text-white font-bold left-8 absolute z-[2] bottom-8'>
            ...
            <ul className="flex pt-10 max-lg:flex-wrap max-lg:gap-4 justify-center">
                    {data?.readmoredata?.map((item , index) => (
                        <li className="flex-1 mx-3 bg-darkgrey rounded-xl p-6 text-white max-lg:mx-0 max-md:max-w-[70%] max-lg:basis-[70%] max-sm:max-w-[100%] max-sm:basis-[100%]" key={index}>
                        <span className='block text-45px max-3xl:text-[40px] max-2xl:text-4xl max-xl:text-3xl max-lg:text-2xl border max-w-16 font-bold text-center rounded-xl'>{item.number}</span>
