        ...
        <div className="container ">
            {learnmore?.learnmore_block?.map((item ,index) => (
                    ...
                    <div className='max-w-[50%] basis-1/2 '>
                            <span className='block text-2xl max-2xl:text-xl max-xl:text-lg font-bold'>{item.subtitle}</span>
                            <h2 className='text-45px max-3xl:text-[40px] max-2xl:text-4xl max-2xl:text-4xl max-xl:text-3xl font-bold'>{item.title}</h2>
                    </div>
                    <div className='max-w-[50%] basis-1/2 '>
                            <hr className='border-1 border-black pb-4'/>
                            <p className='text-lg max-xl:text-base'>{item.content}</p> 
