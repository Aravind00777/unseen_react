            ...
            <ul className='flex items-center '>
                {actioncard?.cards?.map((item ,index)=>(
                    ...
                    <div className='relative z-[1]'>
                        ...
                        <span className='block bg-[rgba(0,0,0,.7)] absolute bottom-0 left-0 right-0 w-full p-5 text-2xl max-3xl:text-[22px] max-2xl:text-xl font-bold text-white '>{item.cardtitle}</span>
                    </div>
                    <div className='pt-5 pl-5 pr-4 pb-12 bg-lightgrey '>
